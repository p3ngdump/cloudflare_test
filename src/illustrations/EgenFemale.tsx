...
export default function EgenFemale({ mark='♀' }: Props){
  return (
    <svg width="640" height="420" viewBox="0 0 640 420" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(86,64)" filter="url(#shadow)">
        ...
        <path d="M138 154 q22 18 44 0" stroke="#2b2a33" strokeWidth="4" fill="none" strokeLinecap="round"/>
        <path d="M120 168 q40 12 80 0" stroke="#ff86b8" strokeWidth="3" fill="none" opacity="0.6"/>
        <circle cx="130" cy="136" r="10" fill="#ff86b8" opacity="0.6"/>
        <circle cx="190" cy="136" r="10" fill="#ff86b8" opacity="0.6"/>
      </g>
      <g>
        ...
        <text x="420" y="238" fontFamily="sans-serif" fontSize="16" fill="#0f172a">오늘 더 분위기 있다!</text>
