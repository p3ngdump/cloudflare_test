...
export default function EgenFemale({ titleColor, genderMark='♀' }: Props){
  ...
  return (
    <svg width="640" height="420" viewBox="0 0 640 420" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(90,70)" filter="url(#s)">
        ...
        <path d="M110 165 q40 12 80 0" stroke={color} strokeWidth="3" fill="none" opacity="0.6"/>
      </g>
      <g>
        ...
        <text x="420" y="238" fontFamily="sans-serif" fontSize="16" fill="#0f172a">오늘 화장 정말 예뻐!</text>
