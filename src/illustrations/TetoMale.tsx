...
export default function TetoMale({ mark='♂' }: Props){
  return (
    <svg width="640" height="420" viewBox="0 0 640 420" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(86,64)" filter="url(#shadow)">
        ...
        <path d="M138 148 q22 12 44 0" stroke="#2b2a33" strokeWidth="4" fill="none" strokeLinecap="round"/>
        <rect x="110" y="200" width="100" height="56" rx="12" fill="#2563eb" opacity="0.18"/>
      </g>
      <g>
        ...
        <text x="420" y="238" fontFamily="sans-serif" fontSize="16" fill="#0f172a">일정부터 맞추고 보자!</text>
